...
const FloatingBubble: React.FC<{ bubble: Bubble; winHeight: number }> =
  React.memo(({ bubble, winHeight }) => {
    ...
    useEffect(() => {
      ...
      translateX.value = withDelay(
        ...
        withRepeat(
          withSequence(
            withTiming(bubble.swayAmount, {
              duration: bubble.duration / 3,
              easing: Easing.inOut(Easing.quad),
            }),
            withTiming(-bubble.swayAmount, {
              duration: (bubble.duration / 3) * 2,
              easing: Easing.inOut(Easing.quad),
            }),
            withTiming(0, {
              duration: bubble.duration / 3,
...
export const KidsBubbleBackground: React.FC<KidsBubbleBackgroundProps> =
  React.memo(({ bubbleCount = 6, cloudCount = 2 }) => {
