  ...
  return (
    <Animated.View style={[styles.quickItem, entranceStyle]}>
      <Animated.View style={pressStyle}>
        ...
        >
          <LinearGradient colors={item.grad as [string, string]} style={styles.quickIconCircle}>
            {item.icon}
          </LinearGradient>
...
export const QuickActions = React.memo(({ 
  ...
  const actions = useMemo(() => [
    { 
      ...
      grad: (isCurrentActive && isPlaying) ? (['#EC4899', '#8B5CF6'] as const) : (['#6366F1', '#4F46E5'] as const), 
