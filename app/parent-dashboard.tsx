...
export default function ParentDashboard() {
  ...
  const stats = useMemo(() => {
    ...
    const storiesByLanguage = stories.reduce(
      (acc, s) => {
    ...
    const topLanguage = Object.entries(storiesByLanguage).sort(
      (a, b) => b[1] - a[1],
    )[0];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <View
              style={[styles.statIconWrap, { backgroundColor: '#F59E0B15' }]}
            >
          ...
          >
            <View style={styles.weekRow}>
              ...
              <View style={styles.weekInfo}>
                <Text
                  style={[styles.weekLabel, { color: COLORS.text.primary }]}
                >
                  Stories Read
                </Text>
                <View
            ...
            {streak && (
              <View style={styles.weekRow}>
                ...
                <Text
                  style={[styles.weekCount, { color: COLORS.text.primary }]}
                >
                ...
                >
                  ...
                  <View style={styles.activityInfo}>
                    ...
                    <View style={styles.activityMeta}>
                      <Text style={styles.activityFlag}>
        ...
        {isSettingPin && (
          <Animated.View
            ...
            style={[styles.section, styles.pinSection]}
          >
            <Text style={[styles.sectionTitle, { color: COLORS.text.primary }]}>
              Change Parent PIN
            </Text>
