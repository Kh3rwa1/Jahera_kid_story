...
function BounceStar({ delay = 0, color }: { delay?: number; color: string }) {
  ...
  return (
    <Animated.Text
      style={[{ fontSize: 18, color, position: 'absolute' }, style]}
    >
      ⭐
    </Animated.Text>
  );
...
export default function QuizScreen() {
  ...
  useEffect(() => {
    loadQuiz();
    return () => {
      soundCleanupRef.current?.unloadAsync().catch(() => {});
    };
  }, [loadQuiz]);
  ...
  const handleNextQuestion = useCallback(async () => {
    ...
    if (currentQuestionIndex < questions.length - 1) {
      ...
      if (profile && story) {
        await quizService.createAttempt(
          profile.id,
          story.id,
          computed,
          questions.length,
    ...
    (answerOrder: string) => {
      ...
      if (correct) {
        ...
        scoreScale.value = withSequence(
          withSpring(1.6, { damping: 4, stiffness: 700 }),
      ...
      <LinearGradient colors={C.backgroundGradient} style={styles.fill}>
        <SafeAreaView style={styles.centeredSafe}>
          ...
          <Text
            style={[
              styles.loadingText,
              { color: C.text.secondary, fontFamily: FONTS.display },
            ]}
          >
        ...
        <SafeAreaView style={styles.centeredSafe}>
          ...
          >
            ...
            <Text
              style={[
                styles.errorTitle,
                { color: C.text.primary, fontFamily: FONTS.display },
              ]}
            >
            ...
            <Text
              style={[
                styles.errorMsg,
                { color: C.text.secondary, fontFamily: FONTS.medium },
              ]}
            >
              {msg}
            </Text>
            <Pressable
              onPress={loadError ? loadQuiz : () => router.replace('/(tabs)')}
            >
              <LinearGradient
                colors={C.gradients.primary}
      ...
      <LinearGradient colors={C.backgroundGradient} style={styles.fill}>
        ...
        <SafeAreaView style={[styles.fill, { paddingHorizontal: SPACING.xl }]}>
          ...
          <Animated.View
            ...
            style={styles.resultTrophyWrap}
          >
            <LinearGradient
              colors={resultGradient}
              style={styles.resultTrophyRing}
            >
          ...
          <Animated.Text
            ...
            style={[
              styles.resultSub,
              { color: C.text.secondary, fontFamily: FONTS.displayMedium },
            ]}
          >
            {resultSub}
          </Animated.Text>
          ...
          <Animated.View
            ...
            style={styles.resultScoreRing}
          >
            <LinearGradient
              colors={resultGradient}
              style={styles.resultScoreGradient}
            >
              <Text
                style={[
                  styles.resultScorePercent,
          ...
          >
            <View
              style={[
                styles.resultBarTrack,
                { backgroundColor: C.text.light + '22' },
              ]}
            >
              <LinearGradient
                colors={resultGradient}
          ...
          >
            ...
            <Pressable
              ...
              style={({ pressed }) => [
                ...
                { borderColor: C.primary + '30', opacity: pressed ? 0.75 : 1 },
              ]}
            >
              ...
              <Text
                style={[
                  ...
                  { color: C.primary, fontFamily: FONTS.displayBold },
                ]}
              >
                Home
              </Text>
        ...
        <View style={styles.quizHeader}>
          ...
          <View style={styles.headerCenter}>
            <View
              style={[
                ...
                { backgroundColor: C.text.light + '18' },
              ]}
            >
          ...
          <Animated.View style={[styles.scoreChipWrap, scoreAnimStyle]}>
            ...
            >
              ...
              <Text
                style={[styles.scoreChipText, { fontFamily: FONTS.display }]}
              >
                {score}
              </Text>
            </LinearGradient>
        ...
        <Animated.View style={[styles.answersWrap, questionAnimStyle]}>
          {currentQuestion.answers.map((answer, idx) => {
              ...
              answerContent = (
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.answerText,
                      { color: '#fff', fontFamily: FONTS.displayBold },
                    ]}
                  >
                    {answer.answer_text}
                  </Text>
                ...
                <View
                  style={[
                    ...
                    styles.answerCardDefault,
                    {
                      ...
                      borderColor: isSelected ? C.primary : C.glass.border,
                    },
                  ]}
                >
                  <LinearGradient
                  ...
                  <Text
                    style={[
                      styles.answerText,
                      { color: C.text.primary, fontFamily: FONTS.displayBold },
                    ]}
                  >
                    {answer.answer_text}
                  </Text>
            ...
            return (
              <Animated.View
                key={answer.id}
                entering={FadeInDown.delay(260 + idx * 80)
                  .springify()
                  .damping(14)}
                style={[
                  ...
                  style={({ pressed }) => [
                    {
                      flex: 1,
                      transform: [
                        { scale: pressed && !selectedAnswer ? 0.97 : 1 },
                      ],
                    },
                  ]}
                >
        ...
        {selectedAnswer === null && (
          ...
          >
            ...
            <Text
              style={[
                styles.mascotHint,
                { color: C.text.light, fontFamily: FONTS.displayMedium },
              ]}
            >
              ...
              <View style={styles.feedbackText}>
                <Text
                  style={[
                    ...
                    { color: C.success, fontFamily: FONTS.display },
                  ]}
                >
                  Correct!
                </Text>
            ...
            <View style={styles.feedbackInner}>
              ...
              <View style={styles.feedbackText}>
                <Text
                  style={[
                    styles.feedbackTitle,
                    { color: C.error, fontFamily: FONTS.display },
                  ]}
                >
                  Not quite!
                </Text>
