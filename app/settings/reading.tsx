    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          ...
          <Text style={styles.headerSub}>Customize how stories look</Text>
        </View>
        <TouchableOpacity
          onPress={() => {
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.fontSizeRow}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.stepBtnTextMinus}>−</Text>
            </TouchableOpacity>
                ...
                >
                  <Text
                    style={[
                      ...
                      {
                        color:
                          prefs.fontSize === size ? '#FFF' : C.text.secondary,
                      },
                    ]}
                  >
                    {size}
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.stepBtnTextPlus}>+</Text>
            </TouchableOpacity>
          </View>

          <Text style={styles.currentValue}>{prefs.fontSize}px</Text>
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionLabel}>TEXT ALIGNMENT</Text>
          <View style={styles.optionRow}>
              ...
              >
                <Text
                  style={[
                    ...
                    {
                      color:
                        prefs.textAlign === opt.id ? '#FFF' : C.text.secondary,
                    },
                  ]}
                >
                  {opt.label}
        ...
        >
          ...
          <Text style={styles.resetFullBtnText}>Reset to Defaults</Text>
        </TouchableOpacity>
      </ScrollView>
    </View>
  );
