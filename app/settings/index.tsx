...
const useStyles = (C: ColorScheme['colors'], insets: EdgeInsets) => {
  return React.useMemo(() => StyleSheet.create({
    ...
    settingInfo: { flex: 1 },
    settingTitle: { fontSize: FONT_SIZES.lg, fontFamily: FONTS.bold, color: C.text.primary, marginBottom: SPACING.xs },
    settingDescription: { fontSize: FONT_SIZES.sm, lineHeight: 18, color: C.text.secondary },
    restoreRow: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: SPACING.md,
