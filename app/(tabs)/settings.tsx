      ...
      >
        ...
        <View style={styles.rowBody}>
          <Text
            style={[
              styles.rowLabel,
              { color: row.destructive ? COLORS.error : COLORS.text.primary },
            ]}
          >
            {row.label}
          </Text>
        ...
        <View style={styles.rowTrailing}>
          {row.badge ? (
            <View
              style={[
                styles.badge,
                { backgroundColor: row.badgeColor || COLORS.primary },
              ]}
            >
      ...
      rows: [
        {
          id: 'edit-profile',
          label: 'Edit Profile',
          sublabel: profile?.kid_name
            ? `${profile.kid_name}'s profile`
            : 'Update name & avatar',
  ...
  return useMemo(
    () =>
      StyleSheet.create({
        ...
        referralIcon: {
          width: isTablet ? 66 : 58,
          height: isTablet ? 66 : 58,
          borderRadius: isTablet ? 33 : 29,
          alignItems: 'center',
          justifyContent: 'center',
        },
