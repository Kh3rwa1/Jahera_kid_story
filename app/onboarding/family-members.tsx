...
export default function FamilyMembers() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      speak(
        `Wonderful! Now, who are the special people in ${params.kidName}'s family?`,
        lang,
      );
    }, 800);
        ...
        >
          ...
          >
            <View style={styles.topRow}>
              ...
              <View style={styles.progressLineOuter}>
                <View
                  style={[
                    styles.progressFill,
                    { width: '75%', backgroundColor: '#FFFFFF' },
                  ]}
                />
              </View>
            ...
            <View style={styles.heroSection}>
              <LottieView
                source={{
                  uri: 'https://lottie.host/5a2d603a-3453-4876-8804-68f44d9560f7/F677pI8Xq6.json',
                }}
                autoPlay
                loop
              ...
              {familyMembers.length === 0 ? (
                ...
                >
                  ...
                  <Text style={styles.emptySub}>
                    They'll be characters in your stories!
                  </Text>
                </Animated.View>
              ) : (
            ...
            >
              <Text
                style={[
                  styles.ctaText,
                  {
                    color: familyMembers.length > 0 ? C.primaryDark : '#CBD5E1',
                  },
                ]}
              >
                {familyMembers.length > 0
                  ? `Adventure On (${familyMembers.length})`
                  : 'Next Step'}
              </Text>
