...
export default function Friends() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      speak(
        'Almost there! Finally, who are your best friends? We can invite them into the stories too!',
        lang,
      );
    }, 800);
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      const familyMembers = JSON.parse(
        (params.familyMembers as string) || '[]',
      );
      ...
      const profile = await profileService.create(
        ...
        primaryLanguage,
        {
          ...
          region: (params.region as string) || null,
          country: (params.country as string) || 'India',
      ...
      await Promise.all([
        ...
        ...familyMembers.map((name: string) =>
          familyMemberService.add(profile.id, name),
        ),
              ...
              {friends.length === 0 ? (
                ...
                >
                  ...
                  <Text style={styles.emptySub}>
                    Add buddies to join the journey!
                  </Text>
                </Animated.View>
              ) : (
                      ...
                      <View style={styles.sticker}>
                        ...
                        >
                          <Text style={styles.avatarEmoji}>
                            {FRIEND_EMOJIS[idx % FRIEND_EMOJIS.length]}
                          </Text>
                        </View>
            ...
            >
              {isLoading ? (
                ...
                <>
                  ...
                  >
                    <Sparkles size={22} color={C.primaryDark} strokeWidth={3} />
                  </View>
                </>
              )}
            </LinearGradient>
