...
interface AnalyticsData {
  ...
  themeDist: { name: string; value: number }[];
  totalStories: number;
  totalUsers: number;
  avgWords: number;
  audioRate: number;
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-sm text-[var(--text-muted)]">
          Platform usage and content insights
        </p>
      </div>
